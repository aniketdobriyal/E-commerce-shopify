...
export default function NavBar() {
  ...
  // Function to open profile section dynamically
  ...
  return (
    <>
      <style>{`
        ...
        .dropdown-item:not(.signin):hover {
      ...
      >
        ...
        >
          ...
          <div style={{ position: "relative" }}>
            <Dropdown>
              ...
              <Dropdown.Menu className="dropdown-menu-custom" align="end">
                ...
                <Dropdown.Item onClick={() => openProfileSection("orders")}>
                  <FaBoxOpen className="me-2" /> Orders & Returns
                </Dropdown.Item>
                <Dropdown.Item onClick={() => openProfileSection("dashboard")}>
                  <FaUser className="me-2" /> My Profile
                </Dropdown.Item>
                <Dropdown.Item onClick={() => openProfileSection("rewards")}>
          ...
          <Link to="/cart" className="btn p-2 border-0 ms-0 icon-hover">
